        ...
        <main class="flex flex-col bg-white text-center shadow-lg rounded-lg px-4 py-4 mb-4 max-w-lg">
            ...
            <div class="flex bg-gray-200 rounded-lg mb-2">
                ...
                <button id="customize-btn" class="flex flex-col items-center justify-center px-1 border-l border-gray-400" style="width: 70px;"> 
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="w-6 text-gray-900 fill-current"><path d="M6.47 9.8A5 5 0 0 1 .2 3.22l3.95 3.95 2.82-2.83L3.03.41a5 5 0 0 1 6.4 6.68l10 10-2.83 2.83L6.47 9.8z"/></svg>
                    <span class="block text-xs text-gray-700">Customize</span>
                </button>
            </div>
            <a class="flex justify-center text-sm text-gray-800 mb-2 font-bold" id="popup-trigger" href="#">
                <div class="w-5 mx-1 text-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="fill-current"><path d="M10 20a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm2-13c0 .28-.21.8-.42 1L10 9.58c-.57.58-1 1.6-1 2.42v1h2v-1c0-.29.21-.8.42-1L13 9.42c.57-.58 1-1.6 1-2.42a4 4 0 1 0-8 0h2a2 2 0 1 1 4 0zm-3 8v2h2v-2H9z"/></svg>
                </div>
